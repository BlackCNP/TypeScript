...
import type { Scope } from '@typescript-eslint/scope-manager/src/scope';
import { BlockScope, CatchScope, ClassScope, ConditionalTypeScope, ForScope, FunctionExpressionNameScope, FunctionScope, FunctionTypeScope, GlobalScope, MappedTypeScope, ModuleScope, SwitchScope, TSEnumScope, TSModuleScope, TypeScope, WithScope } from '@typescript-eslint/scope-manager/src/scope';
...
import type { Variable } from '@typescript-eslint/scope-manager/src/variable';
